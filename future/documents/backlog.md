...
The Backlog is the shared working inventory between Direction and Shape. It
holds possible work, its maturity, and relationships between items without
turning ideas into accepted requirements.
...
Each item should contain only the information needed to recognize and navigate
the work:
...
- complete user stories or acceptance criteria;
- implementation design or task breakdowns;
- discussion transcripts or speculative alternatives;
- duplicated Feature Brief content; or
- claims that an item is committed merely because it is listed.
- the user's current Shape selection or a transient priority order.
...
Keep items compact. Once an item needs durable behavioural detail, create a
